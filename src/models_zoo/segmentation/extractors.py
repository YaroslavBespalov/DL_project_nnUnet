...
from torch.utils import model_zoo as model_zoo_torch
...
def resnet18(pretrained=True):
    ...
    if pretrained:
        load_weights_sequential(model, model_zoo_torch.load_url(model_urls['resnet18']))
    return model
...
def resnet34(pretrained=True):
    ...
    if pretrained:
        load_weights_sequential(model, model_zoo_torch.load_url(model_urls['resnet34']))
    return model
...
def resnet50(pretrained=True):
    ...
    if pretrained:
        load_weights_sequential(model, model_zoo_torch.load_url(model_urls['resnet50']))
    return model
...
def resnet101(pretrained=True):
    ...
    if pretrained:
        load_weights_sequential(model, model_zoo_torch.load_url(model_urls['resnet101']))
    return model
...
def resnet152(pretrained=True):
    ...
    if pretrained:
        load_weights_sequential(model, model_zoo_torch.load_url(model_urls['resnet152']))
    return model
